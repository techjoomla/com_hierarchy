...
ALTER TABLE `#__hierarchy_users` CHANGE `created_date` `created_date` datetime NULL DEFAULT NULL,
ALTER TABLE `#__hierarchy_users` CHANGE `modified_date` `modified_date` datetime NULL DEFAULT NULL,
